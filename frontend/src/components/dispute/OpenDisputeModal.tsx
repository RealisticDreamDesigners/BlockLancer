...
export function OpenDisputeModal({
  ...
  const userRole = isClient ? 'Client' : isFreelancer ? 'Freelancer' : 'Unknown';
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div>
                  ...
                  <code className="block text-xs font-mono text-gray-600 mt-1">
          ...
          <div className="space-y-2">
            ...
            {/* Hint */}
            {!showError && (
              <p id="reason-hint" className="text-xs text-gray-500">
